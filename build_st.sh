...
LDFLAGS="$CFLAGS -s INITIAL_MEMORY=536870912 -s MAXIMUM_MEMORY=2147483648 -s ALLOW_MEMORY_GROWTH=1 -s MODULARIZE=1 -s INVOKE_RUN=0 -s ENVIRONMENT=worker -s EXPORTED_FUNCTIONS=[_main,_malloc,_free] -s EXPORTED_RUNTIME_METHODS=[FS,ccall,cwrap,callMain,run,setValue,writeAsciiToMemory,stringToUTF8,UTF8ToString,lengthBytesUTF8,stackSave,stackRestore,stackAlloc,allocateUTF8,allocateUTF8OnStack] -s STACK_SIZE=5242880 -s FORCE_FILESYSTEM=1"
